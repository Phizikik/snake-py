...
class Snake:
    ...
    def move(self):
        """Перемещает змейку в заданном направлении, проверяет столкновение."""
...
class Apple:
    ...
    def draw(self):
        ...
        a, b = self.position[0] * GRID_SIZE, self.position[1] * GRID_SIZE
...
def game_over_scr(score, high_score):
    """Определяет работу экрана после проигрыша."""
    while True:
